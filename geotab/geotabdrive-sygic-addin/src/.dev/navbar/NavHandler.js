    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.sygic.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.sygic.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'sygic'){
                    geotab.addin.sygic.blur();
                } else {
                    geotab.addin.sygic.focus(global.api, global.state);
                }
            }
        }, 100);
    }
