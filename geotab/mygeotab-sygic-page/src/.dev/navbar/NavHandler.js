    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.mygeotabSygicPage.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.mygeotabSygicPage.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'mygeotabSygicPage'){
                    geotab.addin.mygeotabSygicPage.blur();
                } else {
                    geotab.addin.mygeotabSygicPage.focus(global.api, global.state);
                }
            }
        }, 100);
    }
